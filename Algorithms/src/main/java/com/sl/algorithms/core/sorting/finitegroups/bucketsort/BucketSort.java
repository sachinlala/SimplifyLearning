package com.sl.algorithms.core.sorting.finitegroups.bucketsort;
...
/**
 * <p>A sorting algorithm (non-stable, out-of-place) that uses O(n) space & provides O(n) best-case and O(n^2) average/worst-case time-complexity.</p>
