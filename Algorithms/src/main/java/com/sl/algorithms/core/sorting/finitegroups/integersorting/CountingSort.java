...
/**
 * <br>A stable special-purpose integer-sorting algorithm with linear time & space complexity = O(N+kMax), the range of legit values in the array i.e. (0..kMax-1).<br>
...
public class CountingSort<T extends Integer> implements SortingEngine<T> {
     ...
     * @param n     - size
     * @param digit - the digit's place to use for sorting, with defaultValue = 1
