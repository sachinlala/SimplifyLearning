package com.sl.algorithms.core.search.majorityelement;

import com.sl.algorithms.core.interfaces.search.MajorityFinder;

/**
 * <br><a href="https://en.wikipedia.org/wiki/Boyer%E2%80%93Moore_majority_vote_algorithm">Boyer Moore Voting Algorithm</a><br>
 * <br><p>Basic idea of the algorithm is if we cancel out each occurrence of an element e with all the other elements that are different from e then e will exist till end if it is a majority element.</p>
 * Majority = n/2
 */
