...
/**
 * <p>In-place algorithm to shuffle the input data.
 * I've used the Naive prefix, simply because the algorithm works on a constant range [0 to n-1] for random-number generation, which implies same number could be chosen again, hence all numbers do not have equal probability.</p>
 */
