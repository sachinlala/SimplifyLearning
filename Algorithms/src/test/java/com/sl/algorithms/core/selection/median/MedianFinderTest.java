...
public class MedianFinderTest<T extends Comparable> {
    ...
    private ShufflingEngine<Integer> integerShufflingEngine = new ShufflingEngine<Integer>() {
    };
    private ShufflingEngine<String> stringShufflingEngine = new ShufflingEngine<String>() {
    };
    ...
    public void testFindMedian() {
        ...
        }
        {
            ...
            Assert.assertThat(integerMedianFinder.findMedian(sampleData), anyOf(is(60), is(76))); // power of Hamcrest !
        }
    }
