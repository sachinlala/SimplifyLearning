...
public class MNFinderTest {
    ...
    public void testFindFirstMissingPositive() {
        ...
        { // dupes
            ...
            Assert.assertEquals(3, missingNumberFinder.findFirstMissingPositive(new int[]{0, 0, 1, 2, 2, 4, 5}));
            Assert.assertEquals(3, missingNumberFinder.findFirstMissingPositive(new int[]{0, 0, 1, 2, 4, 5}));
            Assert.assertEquals(4, missingNumberFinder.findFirstMissingPositive(new int[]{5, 2, 3, 2, 2, 1}));
            Assert.assertEquals(4, missingNumberFinder.findFirstMissingPositive(new int[]{-1, 1, 1, 2, 2, 3}));
        ...
        { // jumbled
            ...
            Assert.assertEquals(1, missingNumberFinder.findFirstMissingPositive(new int[]{-2, -3, -4, -8}));
