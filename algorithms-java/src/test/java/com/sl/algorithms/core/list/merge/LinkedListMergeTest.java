...
public class LinkedListMergeTest {
  ...
  private void testMerge2SortedListsNull() {
    assertNull(mergeEngine.merge2SortedLists(null, null));
    assertEquals("[1]", mergeEngine.merge2SortedLists(new ListNode<>(1), null).toString());
    assertEquals("[2]", mergeEngine.merge2SortedLists(null, new ListNode<>(2)).toString());
  }
  ...
  private void testMerge2SortedLists() {
    ...
    assertEquals("[1,1]", mergeEngine.merge2SortedLists(newList1, newList2).toString());
  ...
  private void testMergeKSortedLists() {
    ...
    assertEquals("[1,1,2,4,4,5,5,6,6]",
    ...
    assertEquals("[A,B,C,D,X,Y,Z,1,2,a,b,c,d]",
