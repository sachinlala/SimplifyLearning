...
public class PolishNationalFlagsSortTest extends BaseTest {
    ...
    public void testPNFSort() {
        ...
        { // add a 3rd color
            ...
            integerSortingEngine.sort(sampleNumbers);
            Assert.assertEquals("[0,0,1,1,2,2]", printArray(sampleNumbers)); // white i.e. 0 is in the beginning, everything else is after that; it's incidental to this data-set that overall sort is achieved
        }
        {
