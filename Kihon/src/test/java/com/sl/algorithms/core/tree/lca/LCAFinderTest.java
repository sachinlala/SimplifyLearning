...
public class LCAFinderTest {
    ...
    private void testBSTLeft() {
        ...
        Assert.assertEquals(bTree.left, lowestCommonAncestorI.findLCABST(bTree, bTree.left.left, bTree.left));
    }
    ...
    private void testBSTRight() {
        ...
        bTree.right = new TreeNode<>(3);
        bTree.right.right = new TreeNode<>(4);
        Assert.assertEquals(bTree.right, lowestCommonAncestorI.findLCABST(bTree, bTree.right, bTree.right.right));
    }
}
