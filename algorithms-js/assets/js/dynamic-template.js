...
<body>
    ...
    <header>
        <div class="header-left">
            ...
            <a href="${config.backPath || (config.basePath ? `${config.basePath}/index.html` : '../../../index.html')}" class="home-link desktop-adjacent">
        ...
        <div class="header-center mobile-only">
            <a href="${config.backPath || (config.basePath ? `${config.basePath}/index.html` : '../../../index.html')}" class="home-link">
                <img src="${config.basePath ? `${config.basePath}/assets/images/sl-logo.svg` : '../../../assets/images/sl-logo.svg'}" alt="SimplifyLearning" style="width: 32px; height: 32px;">
            </a>
        </div>
