...
/**
 * <br>Given an array A = A[1,...,n] and an index kMax (1 ≤ kMax ≤ n), find the kth smallest
 * element
 * of A.<br> <br><a href="https://brilliant.org/wiki/median-finding-algorithm/#">Reference 1</a>
 * <br><a
 * href="https://ocw.mit.edu/courses/electrical-engineering-and-computer-science/6-046j-design-and-analysis-of-algorithms-spring-2012/lecture-notes/MIT6_046JS12_lec01.pdf">Reference
 * 2</a>
 */
